  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 glass border-b border-border h-16 flex items-center px-4 sm:px-6">
      <div className="max-w-7xl mx-auto w-full flex items-center justify-between">
        {/* Left: Brand (Desktop) or Settings (Mobile) */}
        ...
        {/* Right: Brand (Mobile) or Nav links (Desktop) */}
        <div className="flex items-center gap-6 sm:gap-8">
          <div className="md:hidden">
             <Link href="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
              <span className="text-lg font-black tracking-[0.3em] uppercase text-foreground">Orvyra</span>
            </Link>
          </div>
